...
class TwoFactorVerifyScreen extends StatefulWidget {
  final bool ativando; // true = ativando 2FA, false = verificando no login

  const TwoFactorVerifyScreen({super.key, required this.ativando});
  ...
  Future<void> _verificar() async {
    ...
    try {
      ...
      await callable.call({
        ...
        'ativando': widget.ativando,
      });

      if (!mounted) return;
      // Retorna true para quem chamou esta tela
